...
- [x] 3-1. `run-tests` ツール — FiveAM テスト実行
...
- [x] 3-2. `write-test` ツール — テストコード生成・登録
...
- [x] 5-1. `suggest-improvements` ツール — 改善提案機能
...
- [x] 5-2. `/review` REPLコマンド — 提案レビュー・承認フロー
...
- [x] 6-2. `improvement-plan` ツール — 改善計画生成
